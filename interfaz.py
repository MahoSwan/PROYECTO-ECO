...
class StatisticsView(tk.Frame):
    ...
    def create_charts(self):
        ...
        # Gráfico 1: Línea - Clasificaciones por hora
        self.create_line_chart()
        
        # Gráfico 2: Pastel - Distribución por material
    ...
    def update_statistics(self):
        ...
        self.create_pie_chart()  # Recrear (manera simple de actualizar)
...
# Agregar la vista al diccionario de frames en la clase principal
# En __init__ de ClasifiEcoApp, agregar:
# self.frames[StatisticsView] = StatisticsView(self.container, self)

# Agregar botón en el sidebar:
# self.btn_stats = tk.Button(self.sidebar, text="Estadísticas", 
#                            command=lambda: self.show_frame(StatisticsView), ...)

# En update_simulation, agregar:
# if StatisticsView in self.frames:
#     self.frames[StatisticsView].update_statistics()
